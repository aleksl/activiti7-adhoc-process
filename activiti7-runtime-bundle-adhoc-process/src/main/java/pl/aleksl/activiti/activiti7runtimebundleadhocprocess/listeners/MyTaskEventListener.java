...
public class MyTaskEventListener implements TaskRuntimeEventListener {
    ...
    public void onEvent(RuntimeEvent runtimeEvent) {
        ...
        if (runtimeEvent instanceof TaskActivatedEvent)
            ...
            logger.info("Do something, task is completed: " + runtimeEvent.getId());
            logger.info("Do something, task is completed: " + runtimeEvent.getBusinessKey());
            logger.info("Do something, task is completed: " + runtimeEvent.getProcessDefinitionId());
            logger.info("Do something, task is completed: " + runtimeEvent.getProcessDefinitionKey());
            logger.info("Do something, task is completed: " + runtimeEvent.getProcessInstanceId());
            logger.info("Do something, task is completed: " + runtimeEvent.getProcessDefinitionVersion());
            logger.info("Do something, task is completed: " + runtimeEvent.getParentProcessInstanceId());
            logger.info("Do something, task is completed: " + runtimeEvent.getEventType());
            logger.info("Do something, task is completed: " + runtimeEvent.getEntity());
